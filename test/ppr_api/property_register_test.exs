defmodule PprApi.PropertyRegisterTest do
  ...
  describe "has_the_register_been_updated_since?/1" do
    ...
    test "returns true when register was updated after given time" do
      html_response = """
      <div id="LastUpdated">REGISTER LAST UPDATED - 01/01/2023 12:00:00</div>
      """

      with_mock HTTPoison,
        get: fn _url, _headers, _opts -> {:ok, %{status_code: 200, body: html_response}} end do
    ...
    test "returns false when HTTP request fails" do
      with_mock HTTPoison,
        get: fn _url, _headers, _opts -> {:error, %HTTPoison.Error{reason: :timeout}} end do
